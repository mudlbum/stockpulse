...
add('light', 'auto-publish badge (link on chip bg)', L.link, L.chipBg);
add('light', 'auto-publish badge border (UI 3:1)', L.link, L.surface, 3);
...
add('dark', 'auto-publish badge (link on chip bg)', D.link, D.chipBg);
add('dark', 'auto-publish badge border (UI 3:1)', D.link, D.surface, 3);
